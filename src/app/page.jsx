...
import logoPelican from '@/images/logos/pelican-logo.svg'
import logoNasm from '@/images/logos/nasm-logo.svg'
import image2 from '@/images/photos/image-2.jpg'
import image3 from '@/images/photos/image-3.jpg'
import image5 from '@/images/photos/image-5.jpg'
import designsys from '@/images/photos/design-sys.png'
import handmodel from '@/images/photos/final-model.png'
...
function Resume() {
  let resume = [
    ...
    {
      company: 'Cornell Appdev Projects',
      title: 'UI Designer (Quick Filters)',
      logo: logoSpotify,
      start: '2023',
      end: '2023',
    },
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Professional and Project Experience</span>
      </h2>
      ...
      <Button href="https://drive.google.com/file/d/1X-BdWiKSlckW0dlrGqMBFBGDfGjbM-pe/view?usp=sharing" variant="secondary" className="group mt-6 w-full">
        Download Resume
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image5, image3, designsys, handmodel, image2].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
